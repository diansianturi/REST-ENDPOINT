...
def add_review():
	try:
		_json = request.json
		_order_id = __json['_order_id']
		_product_id = __json['product_id']
		_user_id = __json['user_id']
		_rating	= __json['rating']
		_review = __json['review']
		_created_at = __json['created_at']
		_update_at = __json['update_at']
		# _name = _json['name']
		# _email = _json['email']
		# _password = _json['pwd']
